NAME          = interpret_wv
DEPEND        = weaver arithmetic boolean interpret_arithmetic parse_ucs parse_expression parse common
TEST_DEPEND   = weaver arithmetic boolean interpret_arithmetic parse_ucs parse_expression parse common
